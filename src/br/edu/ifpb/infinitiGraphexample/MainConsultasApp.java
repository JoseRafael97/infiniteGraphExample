...
public class MainConsultasApp {
	...
	public static void main(String[] args) throws StorageException, ConfigurationException {
		...
		System.out.println("------------------------------------------");
		List<Pessoa> listPess = grafoDAO.buscarPessoasLigadasDiretamentePorArestas(p1);

		for (int i = 0; i < listPess.size(); i++) {
			System.out.println("MEMBRO: " + i + " " + listPess.get(i).getNome());
		}
		...
		System.out.println(grafoDAO.buscarPessoasLigadasOuIndiretamentellection(p1));
